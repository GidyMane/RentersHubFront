...
export default function ConnectionDetailsPage() {
  ...
  const safeAccess = (obj: any, path: string, fallback: any = "N/A") => {
    try {
  ...
  const fetchConnectionDetails = async (id: string) => {
    ...
    try {
      setLoading(true)
      console.log(`Fetching from: ${baseUrl}accounts/connection/${id}/`)
      ...
      setEditData({
        ...
        moved_in: Boolean(data.moved_in),
      })
    } catch (err) {
  ...
  const saveChanges = async () => {
    if (!editData || !connection || !session?.user?.accessToken) {
      toast.error("Missing required data to save changes")
      return
    }
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.message || `Failed to update connection: ${response.status}`)
      }
  ...
  const formatDate = (dateString: string | null | undefined) => {
    ...
    try {
      ...
      return "Date format error" // Return a friendly message if parsing fails
    }
  }

  try {
    // Only render the main UI when connection is not null
    if (loading) {
      return (
        ...
        <div className="container py-6">
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-10">
              ...
              <Button onClick={() => router.push("/admin/connections")}>Return to Connections</Button>
            </CardContent>
          </Card>
        </div>
      )
    ...
    // Now we know connection is not null
    return (
      <div className="container py-6 space-y-6">
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <div className="p-2 border rounded-md bg-muted/30">
                      {safeAccess(connection, "propertydata.title")}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-2 border rounded-md bg-muted/30">
                      {safeAccess(connection, "propertydata.propertytype.name")}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <Label>Address</Label>
                    <div className="p-2 border rounded-md bg-muted/30">
                      {safeAccess(connection, "propertydata.address")}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-2 border rounded-md bg-muted/30">
                      {safeAccess(connection, "propertydata.owners_contact", "Not provided")}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-2 border rounded-md bg-muted/30">
                      {safeAccess(connection, "propertydata.managed_by", "Not specified")}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-2 border rounded-md bg-muted/30">
                      <Badge
                        variant={safeAccess(connection, "propertydata.is_available", false) ? "default" : "outline"}
                      >
                        {safeAccess(connection, "propertydata.is_available", false) ? "Available" : "Not Available"}
                      </Badge>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-2 border rounded-md bg-muted/30">
                      <Badge
                        variant={safeAccess(connection, "propertydata.is_approved", false) ? "default" : "outline"}
                      >
                        {safeAccess(connection, "propertydata.is_approved", false) ? "Approved" : "Not Approved"}
                      </Badge>
                    </div>
                  </div>
                </div>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-2 border rounded-md bg-muted/30">
                      {formatCurrency(safeAccess(connection, "propertydata.rent_price", "0"))}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-2 border rounded-md bg-muted/30">
                      {formatCurrency(safeAccess(connection, "propertydata.deposit_amount", "0"))}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-2 border rounded-md bg-muted/30">
                      {formatCurrency(safeAccess(connection, "propertydata.water_charges", "0"))}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-2 border rounded-md bg-muted/30">
                      {formatCurrency(safeAccess(connection, "propertydata.water_deposit", "0"))}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-2 border rounded-md bg-muted/30">
                      {formatCurrency(safeAccess(connection, "propertydata.garbage_charges", "0"))}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-2 border rounded-md bg-muted/30">
                      {formatCurrency(safeAccess(connection, "propertydata.security_charges", "0"))}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-2 border rounded-md bg-muted/30">
                      {formatCurrency(safeAccess(connection, "propertydata.other_charges", "0"))}
                    </div>
                  </div>
                </div>
              </CardContent>
    ...
    console.error("Error rendering connection details:", error)
    return (
      <div className="container py-6">
        <div className="flex items-center gap-2 mb-4">
          <Button variant="ghost" size="icon" onClick={() => router.back()}>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-10">
            <p className="text-muted-foreground mb-4">An error occurred while displaying this connection</p>
            <Button onClick={() => router.push("/admin/connections")}>Return to Connections</Button>
          </CardContent>
        </Card>
      </div>

...
import { Phone, Key, Loader2, Eye, EyeOff, Home, ArrowLeft } from "lucide-react"
          ...
          <CardContent className="p-6 sm:p-8">
            <div className="space-y-6">
              ...
              <div className="space-y-2 text-center">
                ...
                <p className="text-gray-600 text-sm sm:text-base">The Place Where Kenyans Come To Find Vacant Houses</p>
              </div>

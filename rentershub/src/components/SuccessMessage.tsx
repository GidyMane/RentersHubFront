  ...
  return (
    <Card className="w-full justify-center max-w-2xl bg-white rounded-xl shadow-2xl overflow-hidden">
      ...
      <CardContent className="p-6 space-y-6">
        ...
        <p>
          While you wait for the approval, feel free to explore our platform and prepare for your journey with RentersHub. You'll receive a notification as soon as your application is approved.
        </p>
        <p>
